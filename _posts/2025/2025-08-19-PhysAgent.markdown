...
date:   2025-08-19 18:04:44 +00:00
image: images/2025/PhysAgent.png
...
---
In this work, we introduce PhysAgent, a novel multi-agent system powered by large language models (LLMs), designed to autonomously execute end-to-end scientific workflows—from hypothesis generation and computational modeling to data analysis and discovery.